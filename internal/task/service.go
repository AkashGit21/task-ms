...
func (tvh *TaskHandler) createTask(w http.ResponseWriter, r *http.Request) {
	...
	taskObject := persistence.Task{
		...
		Title:               req.Title,
		Content:             req.Content,
		HTMLStylizedContent: req.HTMLStylizedContent,
...
/** TODO: Patch certain fields of Task with given ID **/
...
/** TODO: List the available Tasks with filters in paginated view **/
