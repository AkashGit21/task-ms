...
APP_LOG_LEVEL="INFO" APP_HOST="$AUTH_APP_HOST" APP_PORT="$AUTH_APP_PORT" AUTH_DB_HOST="$AUTH_DB_HOST" AUTH_DB_PORT="$AUTH_DB_PORT" AUTH_DB_USER="$AUTH_DB_USER" AUTH_DB_PASSWORD="$AUTH_DB_PASSWORD" AUTH_DB_NAME="$AUTH_DB_NAME" ./auth-service authn
